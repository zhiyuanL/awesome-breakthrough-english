Softbank reported a logging issue recently, in smtp log, for a same session, the time of log point SmtpServerDisconnect is earlier than the one of log point SmtpServerConnectProxySuccess,
